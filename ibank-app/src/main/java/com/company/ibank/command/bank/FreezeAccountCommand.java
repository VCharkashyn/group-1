...
public class FreezeAccountCommand implements Command {
    private static final Logger LOG = Logger.getLogger(FreezeAccountCommand.class);
    private AccountService accountService;

    public FreezeAccountCommand(AccountService accountService) {
    ...
    public String call()  {
        ...
        try {
            do {
                System.out.println("Please enter accountID, which you want to freeze");
        ...
        return "Account with id was frozen:"+id;
    }
}
